...
#
# project.tcl: Tcl script for re-creating project 'zynq_e1'
#
# Generated by Vivado on Sun Jun 23 22:13:14 -03 2019
...
set orig_proj_dir "[file normalize "$origin_dir/zynq_e1"]"

# Create project
create_project zynq_e1 $orig_proj_dir -part xc7z020clg400-1
...
set files [list \
 "[file normalize "$origin_dir/src/verilog"]"\
]
...
puts "INFO: Project created:zynq_e1"

puts "INFO: Recreating block diagram from src/tcl/system.tcl"
source src/tcl/system.tcl

set files [list \
 "[file normalize "$env(BLUESPECDIR)/Verilog.Vivado"]"\
 "[file normalize "$env(BLUESPECDIR)/Verilog"]"\
]
add_files $files
